...
- Create new accounts without leaving Fleet: enter the username, password, birthday and profile field, Fleet pre-fills Roblox's real signup form and imports the account when it's done
